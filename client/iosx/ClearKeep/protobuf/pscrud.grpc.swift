...
internal protocol Grpc_PscrudClientProtocol: GRPCClient {
  func register(
    _ request: Grpc_AuthRequest,
  ...
  func authenticate(
    ...
    callOptions: CallOptions
  ) -> UnaryCall<Grpc_Request, Grpc_AuthResponse>
  ...
  func create(
    _ request: Grpc_PutRequest,
    callOptions: CallOptions
  ) -> UnaryCall<Grpc_PutRequest, Grpc_PutResponse>

  func read(
    _ request: Grpc_GetRequest,
    callOptions: CallOptions
  ) -> UnaryCall<Grpc_GetRequest, Grpc_GetResponse>
  ...
  func delete(
    _ request: Grpc_GetRequest,
    callOptions: CallOptions
  ) -> UnaryCall<Grpc_GetRequest, Grpc_Response>

  func subscribe(
    _ request: Grpc_SubscribeRequest,
    callOptions: CallOptions
  ) -> UnaryCall<Grpc_SubscribeRequest, Grpc_Response>
  ...
  func publish(
    _ request: Grpc_PublishRequest,
    callOptions: CallOptions
  ) -> UnaryCall<Grpc_PublishRequest, Grpc_Response>

  func listen(
    _ request: Grpc_Request,
    callOptions: CallOptions,
    handler: @escaping (Grpc_Publication) -> Void
  ) -> ServerStreamingCall<Grpc_Request, Grpc_Publication>

}

extension Grpc_PscrudClientProtocol {
  internal func register(
    _ request: Grpc_AuthRequest
  ) -> UnaryCall<Grpc_AuthRequest, Grpc_AuthResponse> {
    return self.register(request, callOptions: self.defaultCallOptions)
  }

  internal func login(
    _ request: Grpc_AuthRequest
  ) -> UnaryCall<Grpc_AuthRequest, Grpc_AuthResponse> {
    return self.login(request, callOptions: self.defaultCallOptions)
  }

  internal func authenticate(
    _ request: Grpc_Request
  ) -> UnaryCall<Grpc_Request, Grpc_AuthResponse> {
    return self.authenticate(request, callOptions: self.defaultCallOptions)
  }

  internal func logout(
    _ request: Grpc_Request
  ) -> UnaryCall<Grpc_Request, Grpc_Response> {
    return self.logout(request, callOptions: self.defaultCallOptions)
  }

  internal func deregister(
    _ request: Grpc_Request
  ) -> UnaryCall<Grpc_Request, Grpc_Response> {
    return self.deregister(request, callOptions: self.defaultCallOptions)
  }

  internal func create(
    _ request: Grpc_PutRequest
  ) -> UnaryCall<Grpc_PutRequest, Grpc_PutResponse> {
    return self.create(request, callOptions: self.defaultCallOptions)
  }

  internal func read(
    _ request: Grpc_GetRequest
  ) -> UnaryCall<Grpc_GetRequest, Grpc_GetResponse> {
    return self.read(request, callOptions: self.defaultCallOptions)
  }

  internal func update(
    _ request: Grpc_PutRequest
  ) -> UnaryCall<Grpc_PutRequest, Grpc_PutResponse> {
    return self.update(request, callOptions: self.defaultCallOptions)
  }

  internal func delete(
    _ request: Grpc_GetRequest
  ) -> UnaryCall<Grpc_GetRequest, Grpc_Response> {
    return self.delete(request, callOptions: self.defaultCallOptions)
  }

  internal func subscribe(
    _ request: Grpc_SubscribeRequest
  ) -> UnaryCall<Grpc_SubscribeRequest, Grpc_Response> {
    return self.subscribe(request, callOptions: self.defaultCallOptions)
  }

  internal func unsubscribe(
    _ request: Grpc_SubscribeRequest
  ) -> UnaryCall<Grpc_SubscribeRequest, Grpc_Response> {
    return self.unsubscribe(request, callOptions: self.defaultCallOptions)
  }

  internal func publish(
    _ request: Grpc_PublishRequest
  ) -> UnaryCall<Grpc_PublishRequest, Grpc_Response> {
    return self.publish(request, callOptions: self.defaultCallOptions)
  }
  ...
  internal func listen(
    ...
    return self.listen(request, callOptions: self.defaultCallOptions, handler: handler)
  }

}

internal final class Grpc_PscrudClient: Grpc_PscrudClientProtocol {
...
extension Grpc_Datum: GRPCProtobufPayload {}
