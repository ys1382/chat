...
internal protocol Grpc_ChatClientProtocol {
  ...
  func authenticate(_ request: Grpc_Request, callOptions: CallOptions?) -> UnaryCall<Grpc_Request, Grpc_Response>
...
internal final class Grpc_ChatClient: GRPCClient, Grpc_ChatClientProtocol {
  ...
  ///   - callOptions: Call options; `self.defaultCallOptions` is used if `nil`.
  /// - Returns: A `UnaryCall` with futures for the metadata, status and response.
  internal func authenticate(_ request: Grpc_Request, callOptions: CallOptions? = nil) -> UnaryCall<Grpc_Request, Grpc_Response> {
    return self.makeUnaryCall(path: "/grpc.Chat/Authenticate",
                              request: request,
                              callOptions: callOptions ?? self.defaultCallOptions)
  }
  ...
  internal func create(_ request: Grpc_PutRequest, callOptions: CallOptions? = nil) -> UnaryCall<Grpc_PutRequest, Grpc_PutResponse> {
    return self.makeUnaryCall(path: "/grpc.Chat/Create",
                              request: request,
                              callOptions: callOptions ?? self.defaultCallOptions)
  }
  ...
  internal func read(_ request: Grpc_GetRequest, callOptions: CallOptions? = nil) -> UnaryCall<Grpc_GetRequest, Grpc_GetResponse> {
    return self.makeUnaryCall(path: "/grpc.Chat/Read",
                              request: request,
                              callOptions: callOptions ?? self.defaultCallOptions)
  }
  ...
  internal func update(_ request: Grpc_PutRequest, callOptions: CallOptions? = nil) -> UnaryCall<Grpc_PutRequest, Grpc_PutResponse> {
    return self.makeUnaryCall(path: "/grpc.Chat/Update",
                              request: request,
                              callOptions: callOptions ?? self.defaultCallOptions)
  }
  ...
  internal func delete(_ request: Grpc_GetRequest, callOptions: CallOptions? = nil) -> UnaryCall<Grpc_GetRequest, Grpc_Response> {
    return self.makeUnaryCall(path: "/grpc.Chat/Delete",
                              request: request,
                              callOptions: callOptions ?? self.defaultCallOptions)
  }
  ...
  internal func subscribe(_ request: Grpc_SubscribeRequest, callOptions: CallOptions? = nil) -> UnaryCall<Grpc_SubscribeRequest, Grpc_Response> {
    return self.makeUnaryCall(path: "/grpc.Chat/Subscribe",
                              request: request,
                              callOptions: callOptions ?? self.defaultCallOptions)
  }
  ...
  internal func unsubscribe(_ request: Grpc_SubscribeRequest, callOptions: CallOptions? = nil) -> UnaryCall<Grpc_SubscribeRequest, Grpc_Response> {
    return self.makeUnaryCall(path: "/grpc.Chat/Unsubscribe",
                              request: request,
                              callOptions: callOptions ?? self.defaultCallOptions)
  }
  ...
  internal func publish(_ request: Grpc_PublishRequest, callOptions: CallOptions? = nil) -> UnaryCall<Grpc_PublishRequest, Grpc_Response> {
    return self.makeUnaryCall(path: "/grpc.Chat/Publish",
                              request: request,
                              callOptions: callOptions ?? self.defaultCallOptions)
  }
...
internal protocol Grpc_ChatProvider: CallHandlerProvider {
  ...
  func authenticate(request: Grpc_Request, context: StatusOnlyCallContext) -> EventLoopFuture<Grpc_Response>
